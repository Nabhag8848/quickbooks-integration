...
> SELECT * FROM Customer WHERE LastUpdatedTime >= <> ORDERBY Metadata.CreateTime ASC STARTPOSITION 1 MAXRESULTS 1000
> SELECT * FROM Invoice WHERE LastUpdatedTime >= <> ORDERBY Metadata.CreateTime ASC STARTPOSITION 1 MAXRESULTS 1000
